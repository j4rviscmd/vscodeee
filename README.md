...
| GitHub Copilot Chat       | Blocked due to incompatibility with the Bun runtime. The extension is automatically uninstalled and cannot be reinstalled.                                                                                       | All platforms — see [#453](https://github.com/j4rviscmd/vscodeee/issues/453) for details.                                                                                                       |
